...
const SkipCard: React.FC<SkipCardProps> = ({ skip }) => {
  ...
  return (
    <div className="bg-neutral-900 rounded-2xl shadow-md p-6 max-w-sm border border-gray-100">
      {/* Image */}
      <Image
      ...
      <button
        ...
        className="mt-4 w-full py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
      >
        Select Skip
      </button>
    </div>
